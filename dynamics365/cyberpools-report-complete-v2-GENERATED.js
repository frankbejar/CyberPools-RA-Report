...
// Embedded boilerplate from boilerplate.json
const BOILERPLATE = {
    "introduction": {
    ...
    "rating_legends": {
        "control_ratings": {
            "fully_implemented": {
                ...
                "description": "Control(s) are fully implemented and effective at mitigating risk."
            },
            "partially_implemented": {
                "value": 3,
                "label": "Partially Implemented",
                "description": "Controls are partially implemented and somewhat effective in mitigating risk."
            },
            "not_implemented": {
                "value": 5,
                "label": "Not Implemented",
                "description": "Control(s) are nonexistent."
            },
            "not_applicable": {
                "value": 0,
                "label": "Not Applicable",
                "description": "Control(s) are not necessary or applicable to the environment."
            }
        },
        "impact_ratings": {
            "low": {
                "value": 1,
                "label": "Low",
                "description": "Minimal disruption of operations and no sensitive data compromised or exfiltrated."
            },
            "moderate": {
                "value": 3,
                "label": "Moderate",
                "description": "Operational disruptions of operations but no sensitive data compromised or exfiltrated."
            },
            "high": {
                "value": 5,
                "label": "High",
                "description": "Significant disruption of operations and sensitive data compromised or exfiltrated."
            },
            "not_applicable": {
                "value": 0,
                "label": "Not Applicable",
                "description": "No impact to your organization or environment as a result of the missing control."
            }
        },
        "risk_ratings": {
            "low": {
                "range": "0-9",
                "label": "Low",
                "description": "Overall risk is low to organization"
            },
            "moderate": {
                "range": "10-15",
                "label": "Moderate",
                "description": "Overall risk is moderate to organization"
            },
            "high": {
                "range": "16-25",
                "label": "High",
                "description": "Overall risk is high to organization."
            },
            "not_applicable": {
                "range": "0",
                "label": "Not Applicable",
                "description": "No risk posed as a result of the missing control."
            }
        },
        "example": {
    ...
    "categories": {
        ...
        "7.0": {
            ...
            "importance": "Cyber security awareness is essential for organizations to protect their systems, data, and reputation from cyber threats. By educating employees on cyber risks and best practices, organizations can reduce the risk of data breaches, malware infections, and other security incidents. Additionally, cyber security awareness helps to promote a culture of security within the organization, improving compliance with regulations and standards. Finally, cyber security awareness training can help organizations prepare for potential security incidents and respond effectively if they do occur, minimizing the impact on operations and reputation."
        },
        "8.0": {
