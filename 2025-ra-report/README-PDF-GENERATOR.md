...
### 1. **PDF Report Generator** (this directory)
Production system for generating branded PDF reports from CRM assessment data.

### 2. **2026 Grading Methodology** ([grading/](grading/))
**Status:** Pre-Production - Pending Final Approval

Comprehensive analysis and recommendation for the 2026 Risk Assessment grading redesign. Contains:
- **Grade Ceiling Model** - Recommended methodology to replace flat scoring
- Evaluation of 4 grading approaches with evidence-based recommendation
- Statistical analysis, insurance market alignment validation
- Ready for leadership review and PhD-level academic scrutiny

**See [grading/README.md](grading/README.md) for full details.**
